          ...
          <div className="lg:col-span-5 bg-white rounded-2xl border border-slate-100 p-4 shadow-sm space-y-4">
            ...
            <div className="space-y-2 overflow-y-auto max-h-[420px] pr-1 scrollbar-mini">
              ...
              {filteredCustomers.length === 0 && (
                <p className="text-center py-6 text-slate-400 italic text-xs">No registered ledger accounts matches search.</p>
              )}
            </div>
          </div>
          ...
          <div className="lg:col-span-5 bg-white rounded-2xl border border-slate-100 p-4 shadow-sm space-y-4">
            ...
            <div className="space-y-2 overflow-y-auto max-h-[420px] pr-1 scrollbar-mini">
              ...
              {filteredSuppliers.length === 0 && (
                <p className="text-center py-6 text-slate-455">No breeding vendors tracked matching parameters.</p>
              )}
            </div>
          </div>
